    ...
    >
      <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-1">
          ...
          <NavLink href="#workflow">Automation</NavLink>
          <NavLink href="#cta"><span className="inline-flex items-center gap-1"><Rocket size={16}/> Get Started</span></NavLink>
        </div>
        <div className="hidden md:flex items-center gap-3">
          <a href="#cta" className="inline-flex items-center gap-2 px-3 py-2 text-sm rounded-md bg-indigo-600 text-white hover:bg-indigo-700 transition">
            Launch AI
          </a>
        </div>
        <button
      ...
      {open && (
        <div className="md:hidden bg-white border-t border-gray-100">
          <div className="px-4 py-3 flex flex-col gap-1">
            ...
            <NavLink href="#workflow" onClick={closeMenu}>Automation</NavLink>
            <NavLink href="#cta" onClick={closeMenu}>Get Started</NavLink>
          </div>
        </div>
      )}
    </header>
